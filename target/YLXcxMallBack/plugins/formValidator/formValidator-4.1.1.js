	...
	reloadAutoTip : function(validatorGroup)
	{
		...
		$.each(initConfig.validObjects,function()
		{
			if(initConfig.mode == "AutoTip")
			{
				...
				//$("#"+setting.tipID).zIndex=1000;
				$("#"+setting.tipID).show().css({left: x+10+"px", top: y-2+"px"});	//2012.8.9 贺波改			
        //$("#"+setting.tipID).animate({left:x+10+"px",top:y+"px"},"fast");
	...
	return this.each(function(e)
	{
		...
		{			
			...
			{		
				...
				var formValidateTip = $("<div style='position:absolute;z-index:210000;' id='"+tip+"'></div>").appendTo($("body"));
