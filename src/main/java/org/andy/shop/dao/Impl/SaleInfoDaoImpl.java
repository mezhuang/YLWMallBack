...
public class SaleInfoDaoImpl implements SaleInfoDao {
	...
	public String addSaleInfo(Map<String, String> map) throws Exception{
		 ...
		 String addUserGroupSql ="INSERT INTO sales_info ( product_id, transaction_price, transaction_time,customer_phone, guide_phone,is_task,task_name,task_phone, remark) VALUES (:product_id, :transaction_price, :customer_phone, :guide_phone,:is_task,:task_name,:task_phone,:remark)";
