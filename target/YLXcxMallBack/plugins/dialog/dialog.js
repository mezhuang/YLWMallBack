...
dialogTpl =
'<iframe style="position:absolute; visibility:inherit; top:0px; left:0px; height:100%; width:100%; margin:0px; padding:0px; z-index:-1; background-color:#B4B4B4; border-width:0px; filter=\"progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=70)\";" frameborder="0" scrolling="no" width="100%" height="2000px;" class="al2" id="ifr"></iframe>'+
