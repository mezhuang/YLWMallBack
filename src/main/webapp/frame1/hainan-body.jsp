...
function getActivitytableList() {
    $.ajax({
        url: '<%=basePath%>' + 'LeaderActivityDetailManage_getLeaderListIndex.do',
        async: true,
        type: "post",
        dataType: 'text',
        traditional: true,
...
function openMoreActivity(){
	var url = "<%=basePath%>LeaderActivityManage_toThisLeaderActivityList.do";	
	onMenuClick("ad289424-a9aa-4c5c-ba3f-83b779394166", "更多领导活动", url);
}
    ...
    <div class="nra">
        ...
        <div class="activity">
           ...
           <div class="activitybt">
              <span><img src="<%=basePath+"frame1/"%>images/ico-huodong.png" /></span>
              <div class="nowtime">
                    <img src="<%=basePath+"frame1/"%>images/time.png" class="clock" /><%=date.split("-")[0]+"年"+date.split("-")[1]+"月"+date.split("-")[2]+"日&nbsp;&nbsp;"+weeks[week_index] %>
              </div>
            </div>
            
           <div class="activitytable">
               <table id="activitytable_table" cellpadding="10"  width="100%" cellspacing="10" border="0">
                </table>
               <div align="center"> <span><a href="javascript:void(0);"  onclick="openMoreActivity()"  ><<更多领导活动>></a></span></div>
            </div>   
        </div>
